/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eb11b15c41e7794b3d7a7284420a9fb5)
...
interface __BaseEnv_Env {
	...
	MEMORY_PROFILE: DurableObjectNamespace<import("./src/index").MemoryProfile>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MemoryProfile";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENROUTER_MODEL" | "OPENROUTER_API_KEY" | "MEMORY_API_TOKEN">> {}
}
